<div class="modal">
  <div class="modal__container">
    <div class="modal__featured">
      ...
      <img src="https://cloud.githubusercontent.com/assets/3484527/19622568/9c972d44-987a-11e6-9dcc-93d496ef408f.png"
          ...
          <li class="form-list__row form-list__row--inline">
            <div>
              ...
              <div class="form-list__input-inline">
                <input type="text" name="cc_month" placeholder="MM" pattern="\\d*" minlength="2" maxlength="2"
                  required="" />
                <input type="text" name="cc_year" placeholder="YY" pattern="\\d*" minlength="2" maxlength="2"
                  required="" />
              </div>
            </div>
            <div>
...
<center><img src="img/img-5.jpg" <>
  <p style="color:red;">Datorspēles datori</p>

  <div class="container">
    <div class="row justify-content-center">
      <div class="col-12 mt-5">
        <button type="submit" class="btn btn-success" id="submit">
          <a href="bank.html" id="cta-button-solid" class="btn btn-large btn-rounded btn-light-solid">Pirkt </a>